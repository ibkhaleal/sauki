  ...
  <div>
    ...
    <div class="my-5 mx-5 relative pb-12">
      ...
      <div class="grid grid-cols-4 gap-3 pb-5">
         ...
         $selected1 = mysqli_query($link,$select1);
         while($data1 = mysqli_fetch_array($selected1)){
         $hcode = $data1['hcode'];
         $himg = $data1['hpic'];
         $hname = $data1['hname'];
        ...
        <p class="text-center text-blue-500 font-semibold text-sm pb-4">'.$hname.'</p>
            <a class="flex w-full h-full" href="./hospital1.php?hcode='.$hcode.'">
                <img class="flex w-full h-full object-cover" src="admin/images/'.$himg.'" alt="hospital">
            </a>
        </div>
        ';
       }
