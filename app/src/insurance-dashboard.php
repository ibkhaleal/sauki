    ...
    <div class="my-5 mx-5 relative pb-12">
      ...
      <div class="mb-10 space-y-5">
        <div class="bg-white rounded-lg py-3 px-4">
          <p class="font-semibold text-sm">Balance</p>
          <p class="font-bold text-3xl font-varela py-3 text-green-500">N<?php echo $bal;?></p>
        </div>
        <div class="bg-white rounded-lg py-3 px-4">
          <p class="font-semibold text-sm">Amount you can borrow</p>
          <p class="font-bold text-3xl font-varela py-3 text-orange-500">N10,000</p>
        </div>
        <div class="bg-white rounded-lg py-3 px-4">
          <p class="font-semibold text-sm">Amount you owe</p>
          <p class="font-bold text-3xl font-varela py-3 text-red-500">N0</p>
        </div>
      </div>
